...
#   define IFX_CFG_CPU_TRAP_TSR_HOOK(trapWatch)          myTrapExtensionHook(trapWatch)   /**< By default macro is empty*/
#endif
#ifndef IFX_CFG_CPU_TRAP_SYSCALL_CPU0_HOOK
#   define IFX_CFG_CPU_TRAP_SYSCALL_CPU0_HOOK(trapWatch) mySysCallExtensionHook(trapWatch) /**< By default macro is empty*/
#endif
