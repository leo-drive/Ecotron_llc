...
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE1_PCACHE  (0)   //Program cache for Cpu1
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE1_DCACHE  (0)   //Data cache for Cpu1


/*Disable the Core2*/
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE2    (0)

//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE2_PCACHE  (0)   //Program cache for Cpu2
//#define IFX_CFG_CPU_CSTART_ENABLE_TRICORE2_DCACHE  (0)   //Data cache for Cpu2
