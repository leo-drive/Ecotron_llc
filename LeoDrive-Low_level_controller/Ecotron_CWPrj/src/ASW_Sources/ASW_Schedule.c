...
void ASW_Schedule_Init(void)
{
  ...
  /**********************************************************/
  /*******asw_flgSingleTask:0********************/
  FP_OS_ASW_L1ms = &Ecotron_step0;     /* Sample time: 1ms */
  FP_OS_ASW_L5ms = &Ecotron_step1;     /* Sample time: 5ms */
  FP_OS_ASW_L10ms = &Ecotron_step2;    /* Sample time: 10ms  */
  FP_OS_ASW_L20ms = &Ecotron_step3;    /* Sample time: 20ms  */
  FP_OS_ASW_L50ms = &Ecotron_step4;    /* Sample time: 50ms  */
  FP_OS_ASW_L100ms = &Ecotron_step5;   /* Sample time: 100ms  */
  FP_OS_ASW_L200ms = &Ecotron_step6;   /* Sample time: 200ms */
  FP_OS_ASW_L500ms = &Ecotron_step7;   /* Sample time: 500ms   */
  FP_OS_ASW_L1000ms = &Ecotron_step8;  /* Sample time: 1000ms */
