function msg = RBF_DBW40_brake(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=6;
  ...
  msg.list{5}='Max_Speed_ID';
  msg.list{6}='WABCOConfigMessage';
  else 
  msg = struct;
  switch msgname 
%%
...
case 'CommandMessage'
    ...
    ECOCAN.CommandMessage.id = hex2dec('313');
...
case 'FeedbackMsg3'
    ...
    ECOCAN.FeedbackMsg3.id = hex2dec('312');
...
case 'FeedbackMsg2'
    ...
    ECOCAN.FeedbackMsg2.id = hex2dec('311');
...
case 'FeedbackMsg1'
    ...
    ECOCAN.FeedbackMsg1.id = hex2dec('310');
...
%%
%Network Node:Vector__XXX
%Message Name:Max_Speed_ID
%Message Number:5
case 'Max_Speed_ID'
    ECOCAN.Max_Speed_ID = struct;
    ECOCAN.Max_Speed_ID.name = 'Max_Speed_ID';
    ECOCAN.Max_Speed_ID.description = 'Max_Speed_ID';
    ECOCAN.Max_Speed_ID.protocol  = 'ECOCAN';
    ECOCAN.Max_Speed_ID.id = hex2dec('300');
    ECOCAN.Max_Speed_ID.idext = 'STANDARD';
    ECOCAN.Max_Speed_ID.payload_size =8;
    ECOCAN.Max_Speed_ID.interval =-1;

    ECOCAN.Max_Speed_ID.fields{1}.name = 'Max_Speed';
    ECOCAN.Max_Speed_ID.fields{1}.units = '-';
    ECOCAN.Max_Speed_ID.fields{1}.start_bit = 0;
    ECOCAN.Max_Speed_ID.fields{1}.bit_length = 32;
    ECOCAN.Max_Speed_ID.fields{1}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.Max_Speed_ID.fields{1}.data_type = 'FLOAT32';
    ECOCAN.Max_Speed_ID.fields{1}.scale = 1;
    ECOCAN.Max_Speed_ID.fields{1}.offset = 0;
    ECOCAN.Max_Speed_ID.fields{1}.multiplex_type = 'Standard';
    ECOCAN.Max_Speed_ID.fields{1}.multiplex_value = 0;
