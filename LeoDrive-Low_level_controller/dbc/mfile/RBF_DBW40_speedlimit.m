function msg = RBF_DBW40_speedlimit(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=6;
  msg.list= cell(1, msg.num);
  msg.list{1}='Max_Speed_ID';
  msg.list{2}='CommandMessage';
  msg.list{3}='FeedbackMsg3';
  msg.list{4}='FeedbackMsg2';
  msg.list{5}='FeedbackMsg1';
