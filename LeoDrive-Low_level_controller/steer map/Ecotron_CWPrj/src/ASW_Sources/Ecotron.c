...
/* Named constants for Chart: '<S228>/Chart' */
#define IN_NO_ACTIVE_CHILD             ((uint8_T)0U)
#define IN_init                        ((uint8_T)1U)
#define IN_trigger                     ((uint8_T)2U)

/* Named constants for Chart: '<S228>/Chart1' */
...
/* Named constants for Chart: '<S242>/Chart1' */
#define IN_Move                        ((uint8_T)1U)
#define IN_StopMode                    ((uint8_T)2U)

/* Named constants for Chart: '<S240>/Chart' */
...
/* Named constants for Chart: '<S459>/Chart' */
...
__RWP const volatile real32_T Activate_ThrottleControllerOvrCal_val = 0.0F;/* Referenced by: '<S466>/calibration' */
__RWP const volatile boolean_T Activate_ThrottleControllerOvrEn_val = 0;/* Referenced by: '<S466>/override' */
__RWP const volatile real32_T Brake_CalibCMDOvrCal_val = 0.0F;/* Referenced by: '<S394>/calibration' */
__RWP const volatile boolean_T Brake_CalibCMDOvrEn_val = 0;/* Referenced by: '<S394>/override' */
...
__RWP const volatile uint8_T Brake_ResetOvrCal_val = 0U;/* Referenced by: '<S444>/calibration' */
__RWP const volatile boolean_T Brake_ResetOvrEn_val = 0;/* Referenced by: '<S444>/override' */
__RWP const volatile uint8_T Brake_SetDuty = 0U;
                                /* Referenced by: '<S436>/Read Calibration19' */
__RWP const volatile boolean_T Button_Hazard_LightOvrCal_val = 0;/* Referenced by: '<S445>/calibration' */
__RWP const volatile boolean_T Button_Hazard_LightOvrEn_val = 0;/* Referenced by: '<S445>/override' */
__RWP const volatile boolean_T Button_Headlight_FlasherOvrCal_val = 0;/* Referenced by: '<S449>/calibration' */
__RWP const volatile boolean_T Button_Headlight_FlasherOvrEn_val = 0;/* Referenced by: '<S449>/override' */
__RWP const volatile boolean_T Button_HighBeamOvrCal_val = 0;/* Referenced by: '<S448>/calibration' */
__RWP const volatile boolean_T Button_HighBeamOvrEn_val = 0;/* Referenced by: '<S448>/override' */
__RWP const volatile boolean_T Button_Left_BlinkerOvrCal_val = 0;/* Referenced by: '<S446>/calibration' */
__RWP const volatile boolean_T Button_Left_BlinkerOvrEn_val = 0;/* Referenced by: '<S446>/override' */
__RWP const volatile boolean_T Button_Right_BlinkerOvrCal_val = 0;/* Referenced by: '<S447>/calibration' */
__RWP const volatile boolean_T Button_Right_BlinkerOvrEn_val = 0;/* Referenced by: '<S447>/override' */
__RWP const volatile boolean_T Buzz_controlOvrCal_val = 0;/* Referenced by: '<S450>/calibration' */
__RWP const volatile boolean_T Buzz_controlOvrEn_val = 0;/* Referenced by: '<S450>/override' */
...
__RWP const volatile real32_T Set_Brake_PosOvrCal_val = 0.0F;/* Referenced by: '<S443>/calibration' */
__RWP const volatile boolean_T Set_Brake_PosOvrEn_val = 0;/* Referenced by: '<S443>/override' */
__RWP const volatile real32_T Set_GasOvrCal_val = 0.0F;/* Referenced by: '<S465>/calibration' */
__RWP const volatile boolean_T Set_GasOvrEn_val = 0;/* Referenced by: '<S465>/override' */
__RWP const volatile real32_T Set_GearEnableOvrCal_val = 1.0F;/* Referenced by: '<S226>/calibration' */
__RWP const volatile boolean_T Set_GearEnableOvrEn_val = 0;/* Referenced by: '<S226>/override' */
__RWP const volatile uint8_T Set_GearOvrCal_val = 1U;/* Referenced by: '<S229>/calibration' */
__RWP const volatile boolean_T Set_GearOvrEn_val = 0;/* Referenced by: '<S229>/override' */
__RWP const volatile real32_T SteeringWheelRateOvrCal_val = 0.0F;/* Referenced by: '<S477>/calibration' */
__RWP const volatile boolean_T SteeringWheelRateOvrEn_val = 0;/* Referenced by: '<S477>/override' */
__RWP const volatile real32_T Steering_ControlModeOvrCal_val = 0.0F;/* Referenced by: '<S479>/calibration' */
__RWP const volatile boolean_T Steering_ControlModeOvrEn_val = 0;/* Referenced by: '<S479>/override' */
__RWP const volatile real32_T Steering_ResetCommandOvrCal_val = 0.0F;/* Referenced by: '<S480>/calibration' */
__RWP const volatile boolean_T Steering_ResetCommandOvrEn_val = 0;/* Referenced by: '<S480>/override' */
__RWP const volatile real32_T Steering_Set_PosOvrCal_val = 0.0F;/* Referenced by: '<S478>/calibration' */
__RWP const volatile boolean_T Steering_Set_PosOvrEn_val = 0;/* Referenced by: '<S478>/override' */
...
__RWP const volatile boolean_T debug_PCheardbeatOvrCal_val = 0;/* Referenced by: '<S398>/calibration' */
__RWP const volatile boolean_T debug_PCheardbeatOvrEn_val = 0;/* Referenced by: '<S398>/override' */
__RWP const volatile boolean_T debug_otonomDisableOvrCal_val = 0;/* Referenced by: '<S397>/calibration' */
__RWP const volatile boolean_T debug_otonomDisableOvrEn_val = 0;/* Referenced by: '<S397>/override' */
__RWP const volatile boolean_T debug_otonomEnableOvrCal_val = 0;/* Referenced by: '<S396>/calibration' */
__RWP const volatile boolean_T debug_otonomEnableOvrEn_val = 0;/* Referenced by: '<S396>/override' */
...
__MP real32_T Activate_ThrottleControllerOvrMsr;/* '<S466>/Switch' */
...
__MP real32_T Brake_CalibCMDOvrMsr;    /* '<S394>/Switch' */
__MP uint8_T Brake_ResetOvrMsr;        /* '<S444>/Switch' */
__MP boolean_T Button_Hazard_LightOvrMsr;/* '<S445>/Switch' */
__MP boolean_T Button_Headlight_FlasherOvrMsr;/* '<S449>/Switch' */
__MP boolean_T Button_HighBeamOvrMsr;  /* '<S448>/Switch' */
__MP boolean_T Button_Left_BlinkerOvrMsr;/* '<S446>/Switch' */
__MP boolean_T Button_Right_BlinkerOvrMsr;/* '<S447>/Switch' */
__MP boolean_T Buzz_controlOvrMsr;     /* '<S450>/Switch' */
__MP boolean_T Diag_BrakePowerErr;     /* '<S201>/OR7' */
__MP boolean_T Diag_By_wirePowerErr;   /* '<S201>/OR1' */
__MP boolean_T Diag_EPASPowerErr;      /* '<S201>/OR6' */
__MP boolean_T Diag_KL75;              /* '<S203>/OR' */
__MP boolean_T Diag_PDS_BUSErr;        /* '<S205>/Compare' */
__MP boolean_T Diag_PDS_HeartbeatErr;  /* '<S201>/OR' */
__MP boolean_T Diag_isMotorrunning;    /* '<S203>/OR1' */
...
__MP boolean_T PwrM_flgKeyOnDelay;     /* '<S420>/debounce' */
__MP boolean_T PwrM_flgKeyOnRaw;       /* '<S413>/Switch' */
__MP real32_T SetACCOvrMsr;            /* '<S178>/Switch' */
__MP real32_T Set_Brake_PosOvrMsr;     /* '<S443>/Switch' */
__MP real32_T Set_GasOvrMsr;           /* '<S465>/Switch' */
__MP real32_T Set_GearEnableOvrMsr;    /* '<S226>/Switch' */
__MP uint8_T Set_GearOvrMsr;           /* '<S229>/Switch' */
__MP real32_T SteeringWheelRateOvrMsr; /* '<S477>/Switch' */
__MP real32_T Steering_Angle;          /* '<S110>/Product' */
__MP real32_T Steering_Angle_Speed;    /* '<S110>/Product1' */
__MP real32_T Steering_ControlModeOvrMsr;/* '<S479>/Switch' */
__MP real32_T Steering_ResetCommandOvrMsr;/* '<S480>/Switch' */
__MP real32_T Steering_Set_PosOvrMsr;  /* '<S478>/Switch' */
...
__MP real32_T debug_CompensationPID_out;/* '<S295>/Saturation' */
...
__MP boolean_T debug_Errors;           /* '<S197>/OR' */
__MP real32_T debug_Fr_request;        /* '<S241>/Sum' */
__MP boolean_T debug_Mode;             /* '<S197>/Chart' */
__MP boolean_T debug_PCheardbeatOvrMsr;/* '<S398>/Switch' */
__MP real32_T debug_filtered_ACC;      /* '<S244>/Moving Average2' */
__MP boolean_T debug_otonomDisableOvrMsr;/* '<S397>/Switch' */
__MP boolean_T debug_otonomEnableOvrMsr;/* '<S396>/Switch' */
__MP real32_T debug_set_brake;         /* '<S241>/Switch2' */
__MP boolean_T debug_stopmode;         /* '<S242>/Chart1' */
__MP real32_T gear_cnt;                /* '<S228>/Data Type Conversion2' */
...
#define rtCP_uDLookupTable_tableData_b rtCP_pooled_r2WK58RWNLot  /* Computed Parameter: rtCP_uDLookupTable_tableData_b
                                                                  * Referenced by: '<S248>/1-D Lookup Table'
                                                                  */
...
#define rtCP_uDLookupTable_tableData_j rtCP_pooled_6F8ZDledXhTe  /* Computed Parameter: rtCP_uDLookupTable_tableData_j
                                                                  * Referenced by: '<S234>/1-D Lookup Table'
                                                                  */
...
#define rtCP_uDLookupTable_tableData_l rtCP_pooled_f8ctJKsXoJSi  /* Computed Parameter: rtCP_uDLookupTable_tableData_l
                                                                  ...
                                                                  */
#define rtCP_uDLookupTable_bp01Data_l  rtCP_pooled_N87o8IFiLF1E  /* Computed Parameter: rtCP_uDLookupTable_bp01Data_l
                                                                  * Referenced by: '<S241>/1-D Lookup Table'
                                                                  */
...
void flSig2DataCnn50U()
{
  ...
  /*-dataRawType:2U-*/
  tempReal32= (real32_T)(B_n.SteeringWheelRateOvrMsr_k);
  uint32_temp= *((uint32_T*)(&tempReal32));
  dataPtr_tmp[0]= (uint8_T)((uint8_T)((uint32_temp & 0xFF))|dataPtr_tmp[0]);
  dataPtr_tmp[1]= (uint8_T)((uint8_T)((uint32_temp & 0xFF00)>>8U)|dataPtr_tmp[1]);
  dataPtr_tmp[2]= (uint8_T)((uint8_T)((uint32_temp & 0xFF0000)>>16U)|
...
void flSig2DataCnn51U()
{
  ...
  /*-dataRawType:0U-*/
  if (B_n.Steering_ControlModeOvrMsr_d < 0.0) {
    uint32_temp = (uint8_T)0;
  } else if (B_n.Steering_ControlModeOvrMsr_d > 255.0) {
    uint32_temp = (uint8_T)255U;
  } else {
    uint32_temp= (uint8_T)(B_n.Steering_ControlModeOvrMsr_d);
  }
  ...
  /*-dataRawType:1U-*/
  if (0.0 < -128.0) {
    int32_temp = (int8_T)-128;
  } else if (0.0 > 127.0) {
    int32_temp = (int8_T)127;
  } else {
    int32_temp= (int8_T)(0.0);
  }
  ...
  /*-dataRawType:2U-*/
  tempReal32= (real32_T)(B_n.Steering_Set_PosOvrMsr_c);
  uint32_temp= *((uint32_T*)(&tempReal32));
  dataPtr_tmp[2]= (uint8_T)((uint8_T)((uint32_temp & 0xFF))|dataPtr_tmp[2]);
  dataPtr_tmp[3]= (uint8_T)((uint8_T)((uint32_temp & 0xFF00)>>8U)|dataPtr_tmp[3]);
  dataPtr_tmp[4]= (uint8_T)((uint8_T)((uint32_temp & 0xFF0000)>>16U)|
  ...
  /*-dataRawType:0U-*/
  if (B_n.Steering_ResetCommandOvrMsr_c < 0.0) {
    uint32_temp = (uint8_T)0;
  } else if (B_n.Steering_ResetCommandOvrMsr_c > 255.0) {
    uint32_temp = (uint8_T)255U;
  } else {
    uint32_temp= (uint8_T)(B_n.Steering_ResetCommandOvrMsr_c);
  }
...
/* Function for Chart: '<S228>/Chart1' */
static void init(void)
{
  B_n.PtoNTrigger = 0.0;
  B_n.PtoDTrigger = 0.0;
...
void Ecotron_step0(void)               /* Sample time: [0.001s, 0.0s] */
{
  ...
  /* RateTransition generated from: '<S443>/Switch' */
  ...
  /* End of RateTransition generated from: '<S443>/Switch' */
  ...
  /* Outputs for Atomic SubSystem: '<S197>/Rising Edge2' */
  /* Logic: '<S403>/Logical Operator1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S197>/Rising Edge2' */

  /* Outputs for Atomic SubSystem: '<S197>/Rising Edge1' */
  ...
  /* End of Outputs for SubSystem: '<S197>/Rising Edge1' */
   ...
   *  Constant: '<S398>/calibration'
   *  Constant: '<S398>/override'
   */
  ...
  /* Outputs for Atomic SubSystem: '<S197>/Rising Edge3' */
  ...
  /* End of Outputs for SubSystem: '<S197>/Rising Edge3' */

  /* Switch: '<S396>/Switch' incorporates:
   *  Constant: '<S396>/calibration'
   *  Constant: '<S396>/override'
   ...
   *  Constant: '<S397>/calibration'
   *  Constant: '<S397>/override'
  ...
  /* Gain: '<S243>/Multiply1' incorporates:
   *  Gain: '<S243>/Multiply'
   *  Gain: '<S475>/Multiply1'
   *  Sum: '<S243>/Sum'
   */
  ...
  /* End of Chart: '<S242>/Chart1' */

  /* RateTransition generated from: '<S241>/Switch2' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    B_n.TmpRTBAtSwitch2Inport1 = DW_l.TmpRTBAtSwitch2Inport1_Buffer0;
  }

  /* End of RateTransition generated from: '<S241>/Switch2' */

  /* MATLABSystem: '<S244>/Moving Average1' incorporates:
   *  Gain: '<S243>/Multiply1'
   */
  ...
  /* End of MATLABSystem: '<S244>/Moving Average1' */
  ...
  /* MATLABSystem: '<S244>/Moving Average2' */
  ...
  /* End of MATLABSystem: '<S244>/Moving Average2' */
   ...
   *  Constant: '<S241>/Read Calibration'
   *  DiscreteIntegrator: '<S288>/Integrator'
  ...
  /* RateTransition generated from: '<S256>/Product' */
  if (M->Timing.RateInteraction.TID0_5 == 1) {
    B_n.TmpRTBAtProductInport2 = DW_l.TmpRTBAtProductInport2_Buffer0;
  }

  /* End of RateTransition generated from: '<S256>/Product' */
   ...
   *  Constant: '<S444>/calibration'
   *  Constant: '<S444>/override'
   */
   ...
   *  Constant: '<S394>/calibration'
   *  Constant: '<S394>/override'
   */
  ...
  /* RateTransition generated from: '<S436>/Send CAN Message 2' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
  ...
  /* End of RateTransition generated from: '<S436>/Send CAN Message 2' */
   ...
   *  Constant: '<S445>/calibration'
   *  Constant: '<S445>/override'
  ...
  /* S-Function (DIO_Out): '<S437>/Hazard_Light' */
  ...
  /* S-Function (DIO_Out): '<S437>/High_Beam' */
  F_Abstr_HSO_SwitchSet(HSO05,Button_HighBeamOvrMsr);

  /* Switch: '<S446>/Switch' incorporates:
   *  Constant: '<S446>/calibration'
   *  Constant: '<S446>/override'
   *  Switch: '<S458>/Switch'
   */
  ...
  /* S-Function (DIO_Out): '<S437>/Right_Blinker' */
  F_Abstr_HSO_SwitchSet(HSO04,Button_Right_BlinkerOvrMsr);

  /* Outputs for Atomic SubSystem: '<S459>/Rising Edge' */
  ...
  /* End of Outputs for SubSystem: '<S459>/Rising Edge' */

  /* Outputs for Atomic SubSystem: '<S459>/Falling Edge' */
  ...
  /* End of Outputs for SubSystem: '<S459>/Falling Edge' */

  /* Chart: '<S459>/Chart' incorporates:
   *  Constant: '<S459>/Read Calibration'
   *  Constant: '<S459>/Read Calibration1'
   *  Constant: '<S459>/Read Calibration2'
   */
  ...
  /* S-Function (DIO_Out): '<S437>/Switch Output' */
  F_Abstr_LSO_SwitchSet(LSO23,Buzz_controlOvrMsr);

  /* S-Function (DIO_Out): '<S457>/Start_Stop1' incorporates:
   *  Constant: '<S437>/Constant'
   */
  F_Abstr_HSO_SwitchSet(HSO01,false);

  /* RateTransition generated from: '<S241>/Switch1' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    B_n.TmpRTBAtSwitch1Inport3 = DW_l.TmpRTBAtSwitch1Inport3_Buffer0;
  }

  /* End of RateTransition generated from: '<S241>/Switch1' */

  /* Switch: '<S465>/Switch' incorporates:
   *  Constant: '<S465>/calibration'
   *  Constant: '<S465>/override'
   *  Lookup_n-D: '<S438>/1-D Lookup Table'
   *  Switch: '<S241>/Switch1'
   */
  if (Set_GasOvrEn_val) {
   ...
   *  Constant: '<S466>/calibration'
   *  Constant: '<S466>/override'
   */
  ...
  /* RateTransition generated from: '<S438>/Send CAN Message 1' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
  ...
  /* End of RateTransition generated from: '<S438>/Send CAN Message 1' */

  /* Switch: '<S229>/Switch' incorporates:
   *  Constant: '<S229>/calibration'
   *  Constant: '<S229>/override'
   *  Switch: '<S194>/Switch'
   */
   ...
   *  Constant: '<S226>/calibration'
   *  Constant: '<S226>/override'
   */
  ...
  /* Chart: '<S228>/Chart1' incorporates:
   *  Constant: '<S228>/Read Calibration16'
   *  Constant: '<S228>/Read Calibration17'
   *  Constant: '<S228>/Read Calibration18'
   *  Constant: '<S228>/Read Calibration19'
   */
  ...
  /* End of Chart: '<S228>/Chart1' */

  /* Outputs for Enabled SubSystem: '<S439>/Drive ' incorporates:
   *  EnablePort: '<S467>/Enable'
   */
  if (B_n.PtoDTrigger > 0.0) {
    /* S-Function (ecodoer_sendMsg_float): '<S467>/Send CAN Message 1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S439>/Drive ' */

  /* Outputs for Enabled SubSystem: '<S439>/Neutral' incorporates:
   *  EnablePort: '<S468>/Enable'
   */
  if (B_n.NtoDTrigger > 0.0) {
    /* S-Function (ecodoer_sendMsg_float): '<S468>/Send CAN Message 1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S439>/Reverse' */

  /* Outputs for Triggered SubSystem: '<S439>/Reverse1' incorporates:
   *  TriggerPort: '<S470>/Trigger'
   */
  zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,&PrevZCX_p.Reverse1_Trig_ZCE,
                     (B_n.NtoRTrigger));
  if (zcEvent != NO_ZCEVENT) {
    /* S-Function (ecodoer_sendMsg_float): '<S470>/Send CAN Message 1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S439>/Reverse1' */

  /* Outputs for Triggered SubSystem: '<S439>/Reverse2' incorporates:
   *  TriggerPort: '<S471>/Trigger'
   */
  zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,&PrevZCX_p.Reverse2_Trig_ZCE,
                     (B_n.RtoNTrigger));
  if (zcEvent != NO_ZCEVENT) {
    /* S-Function (ecodoer_sendMsg_float): '<S471>/Send CAN Message 1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S439>/Reverse2' */

  /* Outputs for Triggered SubSystem: '<S439>/Reverse3' incorporates:
   *  TriggerPort: '<S472>/Trigger'
   */
  ...
  /* End of Outputs for SubSystem: '<S439>/Reverse3' */

  /* Chart: '<S228>/Chart' incorporates:
   *  Logic: '<S228>/AND'
  ...
  /* S-Function (DIO_Out): '<S439>/Switch Output' */
  F_Abstr_HSO_SwitchSet(HSO07,B_n.Parktrigger);

  /* RateTransition generated from: '<S440>/Send CAN Message 4' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    ...
    /* RateTransition generated from: '<S440>/Send CAN Message 1' */
  ...
  /* End of RateTransition generated from: '<S440>/Send CAN Message 4' */
  ...
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    ...
    /* RateTransition generated from: '<S440>/Send CAN Message 2' */
  ...
  /* End of RateTransition generated from: '<S440>/Send CAN Message 1' */
  ...
  /* RateTransition generated from: '<S440>/Send CAN Message 4' incorporates:
  ...
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    ...
    /* RateTransition generated from: '<S440>/Send CAN Message 2' incorporates:
     *  Constant: '<S222>/Constant'
     *  RelationalOperator: '<S222>/Compare'
     *  RelationalOperator: '<S96>/Relational Operator'
     */
  ...
  /* RateTransition generated from: '<S440>/Send CAN Message 3' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    DW_l.TmpRTBAtSendCANMessage3Inport1_ = Multiply1_tmp;

    /* RateTransition generated from: '<S440>/Send CAN Message 3' incorporates:
     *  Lookup_n-D: '<S474>/1-D Lookup Table'
     */
  ...
  /* End of RateTransition generated from: '<S440>/Send CAN Message 3' */
  ...
  /* End of RateTransition generated from: '<S440>/Send CAN Message 2' */
  ...
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    ...
    /* RateTransition generated from: '<S440>/Send CAN Message ' */
  ...
  /* Outputs for Atomic SubSystem: '<S198>/Rising Edge' */
  ...
  /* End of Outputs for SubSystem: '<S198>/Rising Edge' */

  /* Outputs for Atomic SubSystem: '<S198>/Falling Edge' */
  ...
  /* End of Outputs for SubSystem: '<S198>/Falling Edge' */
  ...
  /* Outputs for Triggered SubSystem: '<S441>/Subsystem' incorporates:
   *  TriggerPort: '<S476>/Trigger'
   */
  zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,&PrevZCX_p.Subsystem_Trig_ZCE,
                     (B_n.Msgtrigger));
  if (zcEvent != NO_ZCEVENT) {
    /* S-Function (ecodoer_sendMsg_float): '<S476>/Send CAN Message ' */
    flSig2DataCnn33U();
  }

  /* End of Outputs for SubSystem: '<S441>/Subsystem' */

  /* Switch: '<S477>/Switch' incorporates:
   *  Constant: '<S477>/calibration'
   *  Constant: '<S477>/override'
   */
  if (SteeringWheelRateOvrEn_val) {
    SteeringWheelRateOvrMsr = SteeringWheelRateOvrCal_val;
  } else {
    SteeringWheelRateOvrMsr = debug_EPASspeedlimit;
  }

  /* End of Switch: '<S477>/Switch' */

  /* Switch: '<S478>/Switch' incorporates:
   *  Constant: '<S478>/calibration'
   *  Constant: '<S478>/override'
   */
  if (Steering_Set_PosOvrEn_val) {
    Steering_Set_PosOvrMsr = Steering_Set_PosOvrCal_val;
  } else {
    Steering_Set_PosOvrMsr = debug_EPASsetsteer;
  }

  /* End of Switch: '<S478>/Switch' */

  /* Switch: '<S479>/Switch' incorporates:
   *  Constant: '<S479>/calibration'
   *  Constant: '<S479>/override'
   */
  if (Steering_ControlModeOvrEn_val) {
    Steering_ControlModeOvrMsr = Steering_ControlModeOvrCal_val;
  } else {
    Steering_ControlModeOvrMsr = (real32_T)debug_EPASmode;
  }

  /* End of Switch: '<S479>/Switch' */

  /* Switch: '<S480>/Switch' incorporates:
   *  Constant: '<S480>/calibration'
   *  Constant: '<S480>/override'
   */
  if (Steering_ResetCommandOvrEn_val) {
    Steering_ResetCommandOvrMsr = Steering_ResetCommandOvrCal_val;
  } else {
    Steering_ResetCommandOvrMsr = (real32_T)debug_EPAS_ECU_reset;
  }

  /* End of Switch: '<S480>/Switch' */

  /* RateTransition generated from: '<S442>/Send CAN Message 1' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    DW_l.SteeringWheelRateOvrMsr_Buffer = SteeringWheelRateOvrMsr;

    /* RateTransition generated from: '<S442>/Send CAN Message 2' */
    DW_l.Steering_ControlModeOvrMsr_Buff = Steering_ControlModeOvrMsr;

    /* RateTransition generated from: '<S442>/Send CAN Message 2' */
    DW_l.Steering_ResetCommandOvrMsr_Buf = Steering_ResetCommandOvrMsr;

    /* RateTransition generated from: '<S442>/Send CAN Message 2' */
    DW_l.Steering_Set_PosOvrMsr_Buffer = Steering_Set_PosOvrMsr;
  }

  /* End of RateTransition generated from: '<S442>/Send CAN Message 1' */
  ...
  /* RateTransition generated from: '<S203>/Delay' */
  if (M->Timing.RateInteraction.TID0_5 == 1) {
    DW_l.rxMO_Kl75_Buffer_n = GOLF_KL75;
  }

  /* End of RateTransition generated from: '<S203>/Delay' */
  ...
  /* RelationalOperator: '<S281>/NotEqual' */
  Compare_pa = (0.0F != csum);

  /* Signum: '<S281>/SignPreSat' */
  if (csum < 0.0F) {
    csum = -1.0F;
  } else {
    if (csum > 0.0F) {
  ...
  /* End of Signum: '<S281>/SignPreSat' */

  /* Product: '<S285>/IProd Out' incorporates:
   *  Constant: '<S241>/Read Calibration1'
   */
  cumRevIndex *= Compensation_I;

  /* RateTransition generated from: '<S241>/Product1' */
  if (M->Timing.RateInteraction.TID0_5 == 1) {
    B_n.TmpRTBAtProduct1Inport2 = DW_l.TmpRTBAtProduct1Inport2_Buffer0;
  }

  /* End of RateTransition generated from: '<S241>/Product1' */

  /* RateTransition generated from: '<S328>/UD' */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    DW_l.stopMode_Buffer = debug_stopmode;

    /* RateTransition generated from: '<S333>/Integrator' */
    DW_l.stopMode_Buffer_d = debug_stopmode;
  }

  /* End of RateTransition generated from: '<S328>/UD' */

  /* RateTransition generated from: '<S249>/Subtract1' incorporates:
  ...
  if (M->Timing.RateInteraction.TID0_2 == 1) {
    ...
    /* RateTransition generated from: '<S373>/UD' incorporates:
     *  Constant: '<S247>/Constant'
     *  Product: '<S241>/Product1'
     *  Sum: '<S249>/Subtract1'
     */
    ...
    /* RateTransition generated from: '<S378>/Integrator' */
    DW_l.stopMode_Buffer_o = debug_stopmode;
  }

  /* End of RateTransition generated from: '<S249>/Subtract1' */

  /* RateTransition generated from: '<S250>/Subtract1' incorporates:
   *  Gain: '<S241>/Gain'
   *  Sum: '<S250>/Subtract1'
   */
  if (M->Timing.RateInteraction.TID0_2 == 1) {
  ...
  /* End of RateTransition generated from: '<S250>/Subtract1' */
  ...
  /* End of Signum: '<S281>/SignPreIntegrator' */

  /* Switch: '<S281>/Switch' incorporates:
   *  Constant: '<S281>/Constant1'
   *  DataTypeConversion: '<S281>/DataTypeConv1'
   *  DataTypeConversion: '<S281>/DataTypeConv2'
   *  Logic: '<S281>/AND3'
...
void Ecotron_step1(void)               /* Sample time: [0.005s, 0.0s] */
{
  ...
  /* Output and update for function-call system: '<S4>/Power Off Management' */
  {
    ...
    /* Outputs for Enabled SubSystem: '<S411>/KeyCycle' incorporates:
     *  EnablePort: '<S414>/Enable'
     */
    PowerOffManagement_ELAPS_T_tmp_ = M->Timing.clockTick1;

    /* End of Outputs for SubSystem: '<S411>/KeyCycle' */
     ...
     *  Constant: '<S411>/Parameter'
     *  Logic: '<S420>/Logical Operator2'
     *  Logic: '<S420>/Logical Operator5'
     *  RelationalOperator: '<S420>/edge'
     *  Sum: '<S433>/Sum1'
     *  UnitDelay: '<S411>/Unit Delay7'
    ...
    if ((DW_l.UnitDelay7_DSTATE != DW_l.UnitDelay_DSTATE_c) && UnitDelay1_p) {
      ...
      /* SampleTimeMath: '<S434>/sample time1'
       *
       * About '<S434>/sample time1':
       *  y = K where K = ( w * Ts )
       */
    ...
    /* Switch: '<S420>/debounce' incorporates:
    ...
    if (PwrM_flgKeyOnDelay) {
      ...
      if ((UnitDelay1_p != DW_l.UnitDelay_DSTATE_j) && (!UnitDelay1_p)) {
        ...
        /* SampleTimeMath: '<S430>/sample time1'
         *
         * About '<S430>/sample time1':
         *  y = K where K = ( w * Ts )
         */
        MinMax1_b = (real_T)PowerOffManagement_ELAPS_T * 0.005;
      ...
      /* Switch: '<S427>/debounce' incorporates:
      ...
      /* End of Switch: '<S427>/debounce' */

      /* Switch: '<S431>/Switch' incorporates:
       *  Constant: '<S411>/Parameter2'
       *  Logic: '<S428>/Logical Operator5'
       *  RelationalOperator: '<S428>/edge'
       *  Sum: '<S431>/Sum1'
      ...
      if ((UnitDelay1_p != DW_l.UnitDelay_DSTATE_jx) && UnitDelay1_p) {
        ...
        /* SampleTimeMath: '<S432>/sample time1'
         *
         * About '<S432>/sample time1':
         *  y = K where K = ( w * Ts )
         */
        MinMax1_b = (real_T)PowerOffManagement_ELAPS_T * 0.005;
      ...
      /* Switch: '<S428>/debounce' incorporates:
      ...
      /* End of Switch: '<S428>/debounce' */

      /* Outputs for Atomic SubSystem: '<S414>/ER_xxxx' */
      ...
      /* End of Outputs for SubSystem: '<S414>/ER_xxxx' */

      /* Outputs for Atomic SubSystem: '<S414>/ER_xxxx1' */
      ...
      /* Outputs for Atomic SubSystem: '<S414>/RSFF_xxxx' */
      ...
      /* End of Outputs for SubSystem: '<S414>/RSFF_xxxx' */
      /* End of Outputs for SubSystem: '<S414>/ER_xxxx1' */

      /* Logic: '<S414>/LogicAND1' incorporates:
       *  Logic: '<S414>/LogicAND'
       *  Logic: '<S414>/LogicNOT'
       *  UnitDelay: '<S425>/Unit Delay1'
       *  UnitDelay: '<S427>/Unit Delay1'
      ...
      /* If: '<S414>/If2' */
      if (B_n.LogicAND1) {
        /* Outputs for IfAction SubSystem: '<S414>/Reset_Action' incorporates:
         *  ActionPort: '<S426>/Action Port'
         */
        /* S-Function (ResetSW): '<S426>/ResetSW' */
        if (true==B_n.LogicAND1) {
          F_Abstr_SoftReset();
        }

        /* End of Outputs for SubSystem: '<S414>/Reset_Action' */
      }
    ...
    /* Outputs for Triggered SubSystem: '<S411>/Shutdown Power' incorporates:
    ...
    if (LogicalOperator_o && (PrevZCX_p.ShutdownPower_Trig_ZCE != ZERO_ZCSIG)) {
      /* S-Function (ecocoder_power_shutdwn): '<S415>/Shutdown Power' */
      F_TLF35584_Off();
    }

    PrevZCX_p.ShutdownPower_Trig_ZCE = UnitDelay1_p;

    /* End of Outputs for SubSystem: '<S411>/Shutdown Power' */

    /* Logic: '<S411>/Logical Operator2' incorporates:
     *  Logic: '<S411>/Logical Operator3'
     *  Logic: '<S411>/Logical Operator5'
     *  Logic: '<S411>/Logical Operator7'
    ...
    /* Outputs for Enabled SubSystem: '<S411>/Shutdown Power Hold' incorporates:
     *  EnablePort: '<S416>/Enable'
     */
    if (LogicalOperator_o) {
      /* S-Function (ecocoder_power_shutdwn): '<S416>/Shutdown Power' */
      F_TLF35584_Off();
    }

    /* End of Outputs for SubSystem: '<S411>/Shutdown Power Hold' */

    /* Outputs for Triggered SubSystem: '<S411>/Software Reset' incorporates:
     *  TriggerPort: '<S417>/Trigger'
     */
    if (PrevZCX_p.SoftwareReset_Trig_ZCE != ZERO_ZCSIG) {
      /* S-Function (ResetSW): '<S417>/ResetSW' incorporates:
    ...
    /* End of Outputs for SubSystem: '<S411>/Software Reset' */

    /* Outputs for Triggered SubSystem: '<S411>/Store All NVM Data' incorporates:
     *  TriggerPort: '<S419>/Trigger'
     */
    if (PrevZCX_p.StoreAllNVMData_Trig_ZCE != ZERO_ZCSIG) {
      /* S-Function (WriteBackData): '<S419>/Store NVM Data1' incorporates:
    ...
    /* End of Outputs for SubSystem: '<S411>/Store All NVM Data' */

    /* S-Function (DI_Key_In): '<S413>/SwitchInput_ReadKeyOn' */
    B_n.SwitchInput_ReadKeyOn= F_Abstr_DI_GetKeyValue(0.0039143865F,1.0F,1.0F);

    /* Switch: '<S413>/Switch' */
    PwrM_flgKeyOnRaw = B_n.SwitchInput_ReadKeyOn;

    /* Update for UnitDelay: '<S411>/Unit Delay7' */
    ...
    /* Update for UnitDelay: '<S411>/Unit Delay4' incorporates:
     *  UnitDelay: '<S411>/Unit Delay5'
     */
    ...
    /* Update for UnitDelay: '<S411>/Unit Delay5' incorporates:
     *  UnitDelay: '<S411>/Unit Delay6'
     */
    DW_l.UnitDelay5_DSTATE = DW_l.UnitDelay6_DSTATE;

    /* Update for UnitDelay: '<S411>/Unit Delay6' */
...
void Ecotron_step2(void)               /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S436>/Send CAN Message 2' incorporates:
   *  Constant: '<S436>/Read Calibration1'
   *  Constant: '<S436>/Read Calibration19'
   */
  flSig2DataCnn43U();
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S438>/Send CAN Message 1' */
  flSig2DataCnn44U();
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S440>/Send CAN Message ' incorporates:
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S440>/Send CAN Message 1' incorporates:
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S440>/Send CAN Message 2' incorporates:
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S440>/Send CAN Message 3' */
  flSig2DataCnn48U();
  ...
  /* S-Function (ecodoer_sendMsg_float): '<S440>/Send CAN Message 4' incorporates:
   *  Constant: '<S440>/Constant3'
   */
  flSig2DataCnn49U();

  /* RateTransition generated from: '<S442>/Send CAN Message 1' */
  B_n.SteeringWheelRateOvrMsr_k = DW_l.SteeringWheelRateOvrMsr_Buffer;

  /* S-Function (ecodoer_sendMsg_float): '<S442>/Send CAN Message 1' */
  flSig2DataCnn50U();

  /* RateTransition generated from: '<S442>/Send CAN Message 2' */
  B_n.Steering_ControlModeOvrMsr_d = DW_l.Steering_ControlModeOvrMsr_Buff;

  /* RateTransition generated from: '<S442>/Send CAN Message 2' */
  B_n.Steering_Set_PosOvrMsr_c = DW_l.Steering_Set_PosOvrMsr_Buffer;

  /* RateTransition generated from: '<S442>/Send CAN Message 2' */
  B_n.Steering_ResetCommandOvrMsr_c = DW_l.Steering_ResetCommandOvrMsr_Buf;

  /* S-Function (ecodoer_sendMsg_float): '<S442>/Send CAN Message 2' incorporates:
  ...
  /* DiscreteIntegrator: '<S333>/Integrator' incorporates:
   *  RateTransition generated from: '<S333>/Integrator'
   */
   ...
   *  Constant: '<S249>/Read Calibration2'
   *  Product: '<S327>/DProd Out'
   *  RateTransition generated from: '<S249>/Subtract1'
   *
   * About '<S328>/TSamp':
   ...
   *  Constant: '<S249>/Read Calibration'
   *  Delay: '<S328>/UD'
   *  DiscreteIntegrator: '<S333>/Integrator'
   *  Product: '<S338>/PProd Out'
   *  RateTransition generated from: '<S249>/Subtract1'
   *  Sum: '<S328>/Diff'
   */
  ...
  /* End of DeadZone: '<S326>/DeadZone' */

  /* RelationalOperator: '<S326>/NotEqual' incorporates:
   *  Gain: '<S326>/ZeroGain'
   */
  NotEqual_j = (0.0 != IProdOut);

  /* Signum: '<S326>/SignPreSat' */
  if (IProdOut < 0.0) {
    IProdOut = -1.0;
  } else {
    if (IProdOut > 0.0) {
  ...
  /* End of Signum: '<S326>/SignPreSat' */

  /* DataTypeConversion: '<S326>/DataTypeConv1' */
  DataTypeConv2_f = (int8_T)IProdOut;

  /* Product: '<S330>/IProd Out' incorporates:
   *  Constant: '<S249>/Read Calibration1'
   *  RateTransition generated from: '<S249>/Subtract1'
   */
  ...
  /* DiscreteIntegrator: '<S378>/Integrator' incorporates:
   *  RateTransition generated from: '<S378>/Integrator'
   */
  ...
  /* SampleTimeMath: '<S373>/TSamp' incorporates:
   *  Constant: '<S250>/Read Calibration2'
   *  Product: '<S372>/DProd Out'
   *  RateTransition generated from: '<S250>/Subtract1'
   *
   * About '<S373>/TSamp':
   *  y = u * K where K = 1 / ( w * Ts )
   */
  ...
  /* Delay: '<S373>/UD' incorporates:
   *  RateTransition generated from: '<S373>/UD'
   */
   ...
   *  Constant: '<S250>/Read Calibration'
   *  Delay: '<S373>/UD'
  ...
  /* RelationalOperator: '<S371>/NotEqual' incorporates:
   *  Gain: '<S371>/ZeroGain'
   */
  NotEqual_d = (0.0F != IProdOut_e);

  /* Signum: '<S371>/SignPreSat' */
  if (IProdOut_e < 0.0F) {
    IProdOut_e = -1.0F;
  } else {
    if (IProdOut_e > 0.0F) {
  ...
  /* End of Signum: '<S371>/SignPreSat' */

  /* DataTypeConversion: '<S371>/DataTypeConv1' */
  DataTypeConv1_n = (int8_T)IProdOut_e;

  /* Product: '<S375>/IProd Out' incorporates:
   *  Constant: '<S250>/Read Calibration1'
   *  RateTransition generated from: '<S250>/Subtract1'
   */
  ...
  /* End of Signum: '<S326>/SignPreIntegrator' */

  /* Switch: '<S326>/Switch' incorporates:
   *  Constant: '<S326>/Constant1'
   *  DataTypeConversion: '<S326>/DataTypeConv2'
   *  Logic: '<S326>/AND3'
  ...
  /* End of Signum: '<S371>/SignPreIntegrator' */

  /* Switch: '<S371>/Switch' incorporates:
   *  Constant: '<S371>/Constant1'
   *  DataTypeConversion: '<S371>/DataTypeConv2'
   *  Logic: '<S371>/AND3'
   *  RelationalOperator: '<S371>/Equal1'
   */
...
void Ecotron_step5(void)               /* Sample time: [0.1s, 0.0s] */
{
  ...
  /* S-Function (DIO_Out): '<S457>/Start_Stop2' */
  ...
  uDLookupTable_d = look1_iflf_binlx(GOLF_GearLevel,
    rtCP_uDLookupTable_bp01Data_l, rtCP_uDLookupTable_tableData_l, 5U);
  ...
  /* End of Update for Delay: '<S203>/Delay' */
}
...
void Ecotron_initialize(void)
{
  ...
  /* Start for MATLABSystem: '<S244>/Moving Average1' */
  ...
  /* Start for MATLABSystem: '<S244>/Moving Average2' */
  ...
  /* InitializeConditions for Delay: '<S328>/UD' */
  DW_l.UD_DSTATE = 0.0;
  ...
  /* InitializeConditions for Delay: '<S373>/UD' */
  DW_l.UD_DSTATE_p = 0.0F;
  ...
  /* InitializeConditions for UnitDelay: '<S411>/Unit Delay7' */
  DW_l.UnitDelay7_DSTATE = true;

  /* InitializeConditions for UnitDelay: '<S411>/Unit Delay4' */
  DW_l.UnitDelay4_DSTATE = true;

  /* InitializeConditions for UnitDelay: '<S411>/Unit Delay5' */
  DW_l.UnitDelay5_DSTATE = true;

  /* InitializeConditions for UnitDelay: '<S411>/Unit Delay6' */
  DW_l.UnitDelay6_DSTATE = true;

  /* SystemInitialize for Enabled SubSystem: '<S411>/KeyCycle' */
  /* SystemInitialize for Atomic SubSystem: '<S414>/ER_xxxx' */
  /* InitializeConditions for UnitDelay: '<S423>/Unit Delay' */
  DW_l.UnitDelay_DSTATE_b = true;

  /* End of SystemInitialize for SubSystem: '<S414>/ER_xxxx' */

  /* SystemInitialize for Atomic SubSystem: '<S414>/ER_xxxx1' */
  /* InitializeConditions for UnitDelay: '<S424>/Unit Delay' */
  DW_l.UnitDelay_DSTATE_ij = true;

  /* End of SystemInitialize for SubSystem: '<S414>/ER_xxxx1' */
  /* End of SystemInitialize for SubSystem: '<S411>/KeyCycle' */

  /* End of SystemInitialize for S-Function (EcoCoder_Task): '<S4>/Task_PwrOff' */

  /* SystemInitialize for Chart: '<S437>/Chart' */
  DW_l.is_HazardOFF = IN_NO_ACTIVE_CHILD;
  DW_l.is_HazardON = IN_NO_ACTIVE_CHILD;
  DW_l.temporalCounter_i1_j = 0U;
  ...
  /* SystemInitialize for Chart: '<S240>/Chart' */
  DW_l.is_active_c5_Ecotron = 0U;
  DW_l.is_c5_Ecotron = IN_NO_ACTIVE_CHILD;

  /* SystemInitialize for Chart: '<S197>/Chart' */
  ...
  /* SystemInitialize for Atomic SubSystem: '<S198>/Rising Edge' */
  /* InitializeConditions for UnitDelay: '<S410>/Unit Delay' */
  DW_l.UnitDelay_DSTATE_ix = true;

  /* End of SystemInitialize for SubSystem: '<S198>/Rising Edge' */

  /* InitializeConditions for MATLABSystem: '<S244>/Moving Average1' */
  if (DW_l.obj.pStatistic->isInitialized == 1) {
    DW_l.obj.pStatistic->pCumSum = 0.0F;
    memset(&DW_l.obj.pStatistic->pCumSumRev[0], 0, 199U * sizeof(real32_T));
    DW_l.obj.pStatistic->pCumRevIndex = 1.0F;
  ...
  /* End of InitializeConditions for MATLABSystem: '<S244>/Moving Average1' */

  /* InitializeConditions for MATLABSystem: '<S244>/Moving Average2' */
  if (DW_l.obj_k.pStatistic->isInitialized == 1) {
    DW_l.obj_k.pStatistic->pCumSum = 0.0F;
    memset(&DW_l.obj_k.pStatistic->pCumSumRev[0], 0, 199U * sizeof(real32_T));
    DW_l.obj_k.pStatistic->pCumRevIndex = 1.0F;
  ...
  /* End of InitializeConditions for MATLABSystem: '<S244>/Moving Average2' */
}
